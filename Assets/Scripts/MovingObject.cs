...
public abstract class MovingObject : MonoBehaviour
{
	...
	protected virtual bool AttemptMove(int xDir, int yDir)
	{
		...
		{
			// If we can't move because something was hit, determine what we hit
			// and then call CantMove with that object.
			if (!canMove)
			{
